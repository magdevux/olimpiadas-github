//console.log(dados); // Para fins de depuração, mostra o conteúdo completo da variável 'dados' no console.
//console.log(dados[0].link); // Mostra o link do primeiro elemento da lista 'dados' no console.
